      ...
      <div className="relative overflow-hidden">
        <div className="flex items-stretch gap-6 whitespace-nowrap animate-scroll-right">
          {[...testimonials, ...testimonials, ...testimonials].map((t, i) => (
            <div
              key={i}
              className="bg-white rounded-2xl shadow-md p-6 sm:p-7 md:p-8 flex-shrink-0 border border-slate-200 text-left 
        ...
        {/* fade kiri-kanan */}
        <div className="absolute left-0 top-0 h-full w-16 bg-gradient-to-r from-putih to-transparent pointer-events-none"></div>
        <div className="absolute right-0 top-0 h-full w-16 bg-gradient-to-l from-putih to-transparent pointer-events-none"></div>
      </div>
    </section>
  );
};
